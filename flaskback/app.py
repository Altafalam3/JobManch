...
def resume_check():
    ...
    if resume_file is not None:
        ...
        pdf_content = input_pdf_setup(os.path.join("uploads", resume_filename))
        input_text = input_pdf_setup(os.path.join("uploads", job_filename))

        prompt = """
        You are an experienced Technical Human Resource Manager,your task is to review the provided resume against the job description. 
        Please share your professional evaluation on whether the candidate's profile aligns with the role. 1st you are provided with JD description and then resume details now,
...
def resume_rate():
    ...
    if resume_file is not None:
        ...
        your task is to evaluate the resume against the provided job description. 1st you are provided with JD description and then resume details now,give me the percentage of match if the resume matches
